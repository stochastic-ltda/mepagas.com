        ...
        init: function() {
            ...
            thiswidth = this.$elem.find('.syco_tooltip').width();
             ...
             data_prog.each(function(){
                ...
                $this1.bind('live focus change click',function(){
                    ...
                    thistooltip.find('p').html('<span class="tooltip_helper">'+thishelper).parent().find('.percentagebarinner').css( "width",parseInt(percentage)+'%').next().html(parseInt(percentage)+'%');                    
